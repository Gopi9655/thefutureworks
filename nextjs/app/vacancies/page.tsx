...
export const metadata: Metadata = {
  title: "Vacancies",
  description: "Browse and filter concept vacancies across Coventry, Warwickshire and the West Midlands.",
};
  ...
  return (
    <>
      <PageHero
        ...
        sub="Search and filter permanent, temporary and part-time concept roles across the West Midlands — by keyword, location, contract type and department."
      >
